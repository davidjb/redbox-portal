...
@NgModule({
  imports: [BrowserModule, FormsModule, ReactiveFormsModule, NKDatetimeModule, Ng2CompleterModule, TranslateI18NextModule, LeafletModule, LeafletDrawModule, MarkdownModule.forRoot(), TreeModule, MobxAngularModule],
